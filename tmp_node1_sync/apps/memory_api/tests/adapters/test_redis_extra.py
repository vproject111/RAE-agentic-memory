...
async def test_redis_init_variants():
    # Patch the global aioredis variable in the rae_adapters.redis module
    import rae_adapters.redis

    with patch.object(rae_adapters.redis, "aioredis") as mock_aioredis:
